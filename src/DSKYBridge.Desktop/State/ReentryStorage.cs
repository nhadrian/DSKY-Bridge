...
{
    public static class CMCStorage
    {
        ...
        public static bool HideVerb;
        public static bool HideNoun;
        public static float BrightnessNumerics;
        public static float BrightnessIntegral;
    ...
    public static class LMCStorage
    {
